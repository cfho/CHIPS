...
export class ChipsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.checkoutForm = this.formBuilder.group({
      ...
      A_LT_POST: [0, Validators.max(2)],
      B_RT_ANT: [0, Validators.max(2)],
      B_LT_ANT: [0, Validators.max(2)],
      B_RT_POST: [0, Validators.max(2)],
      B_LT_POST: [0, Validators.max(2)],
      B_RT_Cingulate: [0, Validators.max(2)],
      B_LT_Cingulate: [0, Validators.max(2)],
      C_RT_ANT: [0, Validators.max(2)],
      C_LT_ANT: [0, Validators.max(2)],
      C_RT_POST: [0, Validators.max(2)],
      C_LT_POST: [0, Validators.max(2)],
      C_RT_Cingulate: [0, Validators.max(2)],
      C_LT_Cingulate: [0, Validators.max(2)],
      D_RT_ANT: [0, Validators.max(2)],
      D_LT_ANT: [0, Validators.max(2)],
      D_RT_POST: [0, Validators.max(2)],
      D_LT_POST: [0, Validators.max(2)],
      MTA_RT: [0, Validators.max(4)],
      MTA_LT: [0, Validators.max(4)],
    });
  }
